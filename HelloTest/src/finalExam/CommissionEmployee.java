...
public class CommissionEmployee extends Employee{
	...
	public CommissionEmployee(String firstName, String lastName, String socialSecurityNumber, int birthMonth, int birthDay, int birthYear, double grossSales, double commissionRate) {
